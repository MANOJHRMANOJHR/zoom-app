...
const RegisterPage = ({ handleChange, formData, handleSubmit }) => (
  <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-6 border-t-4 border-[#FFD700]">
    <h2 className="text-2xl font-bold text-center text-[#FF5D21] mb-4">Register</h2>
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        <label htmlFor="username" className="block text-sm font-medium text-[#4B0082]">
          Username
        </label>
        <input
          type="text"
